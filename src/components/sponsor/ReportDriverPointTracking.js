...
// Import CSS
import './ReportDriverPointTracking.css';

/** 
 *  Generates driver point tracking report
**/ 
const ReportDriverPointTracking = () => {
    ...
    return (
        <div class='ReportDriverPointTracking'>
...
export default ReportDriverPointTracking;