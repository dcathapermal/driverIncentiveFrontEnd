...
// Import CSS
import './ReportSalesBySponsor.css';

/** 
 *  Generates sales by sponsor reports
**/ 
const ReportSalesBySponsor = () => {
    ...
    return (
        <div class='ReportSalesBySponsor'>
...
export default ReportSalesBySponsor;